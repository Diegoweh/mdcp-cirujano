...
export function Footer() {
  return (
    <footer className="bg-[#070707] text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.1fr_1.4fr_1fr] lg:gap-12 lg:px-10">
